...
<body onload="<?= @$pesan ?>" class="select-none">
    ...
    <section id="tabel" class="container">
        <div class="text-center text-3xl font-weight-bold text-primary mt-5">
        ...
        <div class="text-xl font-weight-bold mt-4">1. Matrix Keputusan</div>
        <div class="row mt-4">
            <div class="col-9 overflow-auto mx-auto">
                <table class="table table-striped text-center">
                    <thead class="bg-gray-800 text-light">
                        <tr>
                            <th>Alternatif</th>
                            <?php
            ...
            <div class="col-2 overflow-auto mx-auto">
                <table class="table table-striped text-center">
                    <thead class="bg-gray-800 text-light">
                        <tr>
                            <th>Kriteria</th>
    ...
    <div class="text-xl font-weight-bold mt-4 d-none">2. Rate Kecocokan
        <?php
        $q = "SELECT * FROM tbhitung INNER JOIN tbalternatif ON tbhitung.idalternatif = tbalternatif.idalternatif";
        $query = mysqli_query($koneksi, $q) or die(mysqli_error($koneksi));
        ...
        ?>
            ...
            <div class="text-xl font-semibold mt-8 ml-2">2. Normalisasi Matrix</div>
        <?php
            // Normalisasi berdasarkan nilai kriteria
            $query = mysqli_query($koneksi, $q) or die(mysqli_error($koneksi));
            if (mysqli_num_rows($query) > 0) {
                echo '<table class="table table-striped text-center">';
                echo '<thead class="bg-gray-800 text-light"><tr><th>Alternatif</th>';
        ...
        <div class="text-xl font-semibold mt-8 ml-2">3. Penentuan Nilai Akhir</div>
        <?php
        $q = "SELECT * FROM tbhitung INNER JOIN tbalternatif ON tbhitung.idalternatif = tbalternatif.idalternatif";
        $query = mysqli_query($koneksi, $q) or die(mysqli_error($koneksi));
        ...
        <div class="text-xl font-semibold max-w-md mt-8 ml-2">5. Hasil Rangking</div>
        <?php
        ...
        echo '<table class="table table-striped text-center">';
        echo '<thead class="bg-gray-800 text-light"><tr><th>Alternatif</th><th>Nilai Akhir</th><th>Peringkat</th></tr></thead>';
        echo '<tbody>';
        $peringkat = 1;
